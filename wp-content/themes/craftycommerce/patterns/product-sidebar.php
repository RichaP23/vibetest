<?php
  ...
  * Slug: craftycommerce/product-sidebar
...
<h3 class="has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by price', 'craftycommerce' ); ?></h3>
<!-- /wp:heading -->
...
<h3 class="alignwide has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Categories', 'craftycommerce' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Active filters', 'craftycommerce' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by stock status', 'craftycommerce' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by attribute', 'craftycommerce' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by rating', 'craftycommerce' ); ?></h3>
<!-- /wp:heading -->
...
<h3 class="has-text-align-center has-background-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--60)"><?php echo esc_html__( 'Mega Sale 2023', 'craftycommerce' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"textColor":"background","className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-background-color has-text-color wp-element-button"><?php echo esc_html__( 'Shop Now', 'craftycommerce' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group --></div>
